...
public class AjoutForm extends BaseForm{
    ...
    public AjoutForm(Resources res ) {
        ...
        Component.setSameSize(radioContainer, s1, s2 ,s3,s4);
        ...
        TextField user_name = new TextField("", "user_name");
        user_name.setUIID("TextFieldBlack");
        addStringValue("user_name",user_name);
        ...
        raison.setUIID("TextFieldBlack");
        addStringValue("raison",raison);
      ...
      datePicker.setUIID("TextFieldBlack");
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(user_name.getText().equals("") || lieu.getText().equals("") || raison.getText().equals("")) {
    ...
    Date parsedDate = sdf.parse(                                  sdf.format(new Date()).toString()
);
    

                    rendez_vous rv=new rendez_vous(String.valueOf(user_name.getText()
                                  ).toString(),
                                  String.valueOf(lieu.getText()).toString(),
                            parsedDate
                                                              
,
                            raison.getText().toString()
                            
                                
                                  );
                    
                    System.out.println("data evenement == "+rv);
                    
                    
                    //appelle methode ajouterReclamation mt3 service Reclamation bch nzido données ta3na fi base 
                  ServiceEvenement c= ServiceEvenement.getInstance();
                    c.ajouterEnvenment(rv);
                 //   c.EnvoyerMail();
