...
public class ServiceEvenement {
    ...
    public void ajouterEnvenment (rapport rp){
        String url=Statics.BASE_URL+"/rapportjson?plagiat="+rp.getPlagiat()+"&image_name="+rp.getImage_name()+"&rapp_etudiant_id="+rp.getRapp_etudiant_id();
